...
from authapi.account.serializers import SendPasswordResetEMailSerializer
    ...
    def post(self, request, formate=None):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            if user is not None:
                ...
                return Response({'errors':{'non_field_errors':['Email or pass is not valid']}}, status=status.HTTP_404_NOT_FOUND)
